const movies = [
    {
        id: 1,
        image: "/movies images/action/inffernno.jpg",
    ...
    {
        id: 2,
        image: "/movies images/action/mission.jpg",
        acteurs: "Tom Cruise ",
    ...
    {
        id: 3,
        image: "/movies images/action/split.jpg",
    ...
    {
        id: 4,
        image: "/movies images/action/suc takimi.jpg",
    ...
    {
        id: 5,
        image: "/movies images/arabic/filazra9.jpg",
    ...
    {
        id: 6,
        image: "/movies images/arabic/malwatabi3a.jpg",
    ...
    {
        id: 7,
        image: "/movies images/arabic/Rambo.jpg",
    ...
    {
        id: 8,
        image: "/movies images/cartoons/bbepx.jpg",
    ...
    {
        id: 9,
        image: "/movies images/cartoons/home.jpg",
    ...
    {
        id: 10,
        image: "/movies images/cartoons/luca.jpg",
        acteurs: "Jim Parsons, Steve Martin",
        decription: "Le film de Pixar s'appelle Up (qui se traduit par En haut ou Là-haut), qui a remporté un Oscar. Son titre original en russe est d'ailleurs Вверх (Vverkh). Ce film met en scène un vieil homme qui attache des milliers de ballons à sa maison pour s'envoler.",
        year: "201",
        country: "USA",
    ...
    {
        id: 11,
        image: "/movies images/cartoons/peterpan.jpg",
        acteurs: "Jim Parsons, Steve Martin",
        decription: "Le film de Pixar s'appelle Up (qui se traduit par En haut ou Là-haut), qui a remporté un Oscar. Son titre original en russe est d'ailleurs Вверх (Vverkh). Ce film met en scène un vieil homme qui attache des milliers de ballons à sa maison pour s'envoler.",
        year: "2023",
        country: "USA",
    ...
    {
        id: 12,
        image: "/movies images/cartoons/oneday.jpg",
        acteurs: "Jim Parsons, Steve Martin",
        decription: "Le film de Pixar s'appelle Up (qui se traduit par En haut ou Là-haut), qui a remporté un Oscar. Son titre original en russe est d'ailleurs Вверх (Vverkh). Ce film met en scène un vieil homme qui attache des milliers de ballons à sa maison pour s'envoler.",
        year: "2023",
        country: "USA",
    ...
    {
        id: 13,
        image: "/movies images/cartoons/purplehearts.jpg",
        acteurs: "Jim Parsons, Steve Martin",
        decription: "Le film de Pixar s'appelle Up (qui se traduit par En haut ou Là-haut), qui a remporté un Oscar. Son titre original en russe est d'ailleurs Вверх (Vverkh). Ce film met en scène un vieil homme qui attache des milliers de ballons à sa maison pour s'envoler.",
        year: "2015",
        country: "USA",
    ...
    {
        id: 14,
        image: "/movies images/cartoons/toutsauftoi.jpg",
        acteurs: "Jim Parsons, Steve Martin",
        decription: "Le film de Pixar s'appelle Up (qui se traduit par En haut ou Là-haut), qui a remporté un Oscar. Son titre original en russe est d'ailleurs Вверх (Vverkh). Ce film met en scène un vieil homme qui attache des milliers de ballons à sa maison pour s'envoler.",
        year: "2018",
        country: "USA",
...
// id image, acteurs, descri, year, country, category